...
import '../../S/Seriess.css'

function TWD1_1() {
  return (
    <div className='sox'>
        <iframe src="https://www.2embed.to/embed/tmdb/tv?id=1402&s=1&e=1" frameBorder="0" className='mov' alt='loading' allowFullScreen></iframe>
        <br /><br />
